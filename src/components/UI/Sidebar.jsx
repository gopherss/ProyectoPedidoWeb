                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            ...
                            <a href="/" className="flex ml-2 md:mr-24">
                                <img src="https://www.svgrepo.com/show/234687/restaurant-store.svg" className="h-8 mr-3" alt="FlowBite Logo" />
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <NavLink
                                ...
                                to={"/menu"}
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <img src="https://www.svgrepo.com/show/281382/restaurant-dish.svg" alt="menu icono" className='flex-shrink-0 w-8 h-8' />
                                <span className="flex-1 ml-3 whitespace-nowrap">Menú</span>
                            </NavLink>
                        </li>
                        ...
                        <li>
                            <NavLink
                                ...
                                to={'/'}
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <img src="https://www.svgrepo.com/show/53768/statistics.svg" alt="estadisticas icono" className='flex-shrink-0 w-8 h-8' />
